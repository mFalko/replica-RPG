...
import com.falko.android.snowball.core.PhasedObject;
import com.falko.android.snowball.core.PhasedObjectManager;
import com.falko.android.snowball.core.graphics.DrawableObject;
...
public class RenderSystem extends BaseObject {
    ...
    public void scheduleForDraw(DrawableObject object, Vector2D position, int priority, boolean cameraRelative) {
    ...
    public class RenderElement extends PhasedObject {
        ...
        public void set(DrawableObject drawable, Vector2D position, int priority, boolean isCameraRelative) {
            mDrawable = drawable;
            x = position.x;
            y = position.y;
