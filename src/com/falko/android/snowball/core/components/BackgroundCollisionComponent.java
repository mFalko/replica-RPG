...
public class BackgroundCollisionComponent extends GameComponent {
    ...
    private Vector2D mPreviousCenter;
    private Vector2D mDelta;
    private Vector2D mFilterDirection;
    ...
    private Vector2D mRayStart;
    private Vector2D mRayEnd;
    private Vector2D mTestPointStart;
    private Vector2D mTestPointEnd;
    ...
    public BackgroundCollisionComponent(int width, int height, int horzOffset, int vertOffset) {
        ...
        mPreviousCenter = new Vector2D();
        mDelta = new Vector2D();
        mFilterDirection = new Vector2D();
        ...
        mRayStart = new Vector2D();
        mRayEnd = new Vector2D();
        mTestPointStart = new Vector2D();
        mTestPointEnd = new Vector2D();
...
//                }
    ...
    protected boolean sweepHorizontal(Vector2D previousPosition, Vector2D currentPosition, Vector2D delta, 
            int left, int right, float centerY, Vector2D hitPoint, Vector2D hitNormal, 
    ...
    protected boolean sweepVertical(Vector2D previousPosition, Vector2D currentPosition, Vector2D delta, 
            int bottom, int top, float centerX, Vector2D hitPoint, Vector2D hitNormal,
            GameObject parentObject) {
        boolean hit = false;
