 ...
 */
public class VectorPool extends TObjectPool<Vector2D> {
    ...
    public Vector2D allocate(Vector2D source) {
        Vector2D entry = super.allocate();
        entry.set(source);
        return entry;
    }
