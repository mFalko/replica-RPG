...
import com.falko.android.snowball.core.collision.AABoxCollisionVolume;
...
import com.falko.android.snowball.core.components.HitReactionComponent;
...
public class GameObjectCollisionSystem extends BaseObject {
    ...
    public void update(float timeDelta, BaseObject parent) {
        ...
        for (int x = 0; x < count; x++) {
            ...
            final Vector2D position = record.object.getPosition();
            ...
            for (int y = x + 1; y < count; y++) {
                ...
                final Vector2D otherPosition = other.object.getPosition();
    ...
    private int testAttackAgainstVulnerability(
            ...
            Vector2D vulnerabilityPosition,
