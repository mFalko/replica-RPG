...
/**
 * Provides an interface for controlling a sprite with animations. Manages a
 * list of animations and provides a drawable surface with the correct animation
 * frame to a render component each frame. Also manages horizontal and vertical
 * flipping.
 */
