 ...
 */
public final class Vector2D extends AllocationGuard {
    public float x;
    public float y;
    ...
    public final void subtract(Vector2D other) {
        x -= other.x;
        y -= other.y;
    }
    ...
    public final void multiply(Vector2D other) {
        x *= other.x;
        y *= other.y;
    }
    ...
    public final void set(Vector2D other) {
        x = other.x;
        y = other.y;
    }
    ...
    public final float dot(Vector2D other) {
    ...
    public final float distance2(Vector2D other) {
        float dx = x - other.x;
        float dy = y - other.y;
        return (dx * dx) + (dy * dy);
    }
